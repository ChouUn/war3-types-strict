...
declare var bj_changeLevelMapName: Option<string>;
...
declare var bj_cineFadeContinueTex: Option<string>;
declare var bj_cineFadeContinueTimer: Option<timer>;
declare var bj_cineFadeContinueTrans: number;
declare var bj_cineFadeFinishTimer: Option<timer>;
...
declare var bj_cineModePriorSpeed: Option<gamespeed>;
...
declare var bj_cineSceneBeingSkipped: Option<trigger>;
declare var bj_cineSceneEndingTimer: Option<timer>;
declare var bj_cineSceneLastSound: Option<sound>;
...
declare var bj_crippledTimer: Record<number, Option<timer>>;
declare var bj_crippledTimerWindows: Record<number, Option<timerdialog>>;
declare var bj_dawnSound: Option<sound>;
declare var bj_dayAmbientSound: Option<sound>;
declare var bj_defeatDialogSound: Option<sound>;
declare const bj_DEGTORAD: number;
declare var bj_delayedSuspendDecayTimer: Option<timer>;
declare var bj_delayedSuspendDecayTrig: Option<trigger>;
declare var bj_destInRegionDiesCount: number;
declare var bj_destInRegionDiesTrig: Option<trigger>;
declare var bj_destRandomConsidered: number;
declare var bj_destRandomCurrentPick: Option<destructable>;
declare var bj_dncIsDaytime: boolean;
declare var bj_dncSoundsDawn: Option<trigger>;
declare var bj_dncSoundsDay: Option<trigger>;
declare var bj_dncSoundsDusk: Option<trigger>;
declare var bj_dncSoundsNight: Option<trigger>;
declare var bj_duskSound: Option<sound>;
declare const bj_E: number;
declare var bj_elevatorNeighbor: Option<destructable>;
declare var bj_elevatorWallBlocker: Option<destructable>;
...
declare var bj_enumDestructableCenter: Option<location>;
declare var bj_enumDestructableRadius: number;
declare var bj_finishSoonAllExposed: boolean;
declare var bj_finishSoonTimerDialog: Option<timerdialog>;
declare var bj_forceCountPlayers: number;
declare var bj_forceRandomConsidered: number;
declare var bj_forceRandomCurrentPick: Option<player>;
declare var bj_FORCE_ALL_PLAYERS: Option<force>;
declare var bj_FORCE_PLAYER: Record<number, Option<force>>;
...
declare var bj_gameStartedTimer: Option<timer>;
...
declare var bj_ghoul: Record<number, Option<unit>>;
declare var bj_groupAddGroupDest: Option<group>;
declare var bj_groupCountUnits: number;
declare var bj_groupEnumOwningPlayer: Option<player>;
declare var bj_groupEnumTypeId: number;
declare var bj_groupLastCreatedDest: Option<group>;
declare var bj_groupRandomConsidered: number;
declare var bj_groupRandomCurrentPick: Option<unit>;
declare var bj_groupRemoveGroupDest: Option<group>;
...
declare var bj_isUnitGroupInRectRect: Option<rect>;
...
declare var bj_itemRandomCurrentPick: Option<item>;
...
declare var bj_lastCreatedButton: Option<button>;
declare var bj_lastCreatedDefeatCondition: Option<defeatcondition>;
declare var bj_lastCreatedDestructable: Option<destructable>;
declare var bj_lastCreatedEffect: Option<effect>;
declare var bj_lastCreatedFogModifier: Option<fogmodifier>;
declare var bj_lastCreatedGameCache: Option<gamecache>;
declare var bj_lastCreatedGroup: Option<group>;
declare var bj_lastCreatedHashtable: Option<hashtable>;
declare var bj_lastCreatedImage: Option<image>;
declare var bj_lastCreatedItem: Option<item>;
declare var bj_lastCreatedLeaderboard: Option<leaderboard>;
declare var bj_lastCreatedLightning: Option<lightning>;
declare var bj_lastCreatedMultiboard: Option<multiboard>;
declare var bj_lastCreatedQuest: Option<quest>;
declare var bj_lastCreatedQuestItem: Option<questitem>;
declare var bj_lastCreatedTerrainDeformation: Option<terraindeformation>;
declare var bj_lastCreatedTextTag: Option<texttag>;
declare var bj_lastCreatedTimerDialog: Option<timerdialog>;
declare var bj_lastCreatedUbersplat: Option<ubersplat>;
declare var bj_lastCreatedUnit: Option<unit>;
declare var bj_lastCreatedWeatherEffect: Option<weathereffect>;
declare var bj_lastDyingWidget: Option<widget>;
declare var bj_lastHauntedGoldMine: Option<unit>;
declare var bj_lastLoadedUnit: Option<unit>;
declare var bj_lastPlayedMusic: Option<string>;
declare var bj_lastPlayedSound: Option<sound>;
declare var bj_lastRemovedItem: Option<item>;
declare var bj_lastReplacedUnit: Option<unit>;
declare var bj_lastStartedTimer: Option<timer>;
...
declare var bj_makeUnitRescuableUnit: Option<unit>;
declare var bj_mapInitialCameraBounds: Option<rect>;
declare var bj_mapInitialPlayableArea: Option<rect>;
...
declare var bj_meleeNearestMine: Option<unit>;
declare var bj_meleeNearestMineDist: number;
declare var bj_meleeNearestMineToLoc: Option<location>;
...
declare var bj_meleeVisibilityTrained: Option<trigger>;
...
declare var bj_nightAmbientSound: Option<sound>;
...
declare var bj_questCompletedSound: Option<sound>;
declare var bj_questDiscoveredSound: Option<sound>;
declare var bj_questFailedSound: Option<sound>;
declare var bj_questHintSound: Option<sound>;
declare var bj_questItemAcquiredSound: Option<sound>;
...
declare var bj_questSecretSound: Option<sound>;
...
declare var bj_questUpdatedSound: Option<sound>;
declare var bj_questWarningSound: Option<sound>;
declare var bj_queuedExecTimeout: Option<trigger>;
declare var bj_queuedExecTimeoutTimer: Option<timer>;
declare var bj_queuedExecTotal: number;
declare var bj_queuedExecTriggers: Record<number, Option<trigger>>;
...
declare var bj_randomSubGroupGroup: Option<group>;
...
declare var bj_rescueSound: Option<sound>;
declare var bj_rescueUnitBehavior: Option<trigger>;
declare const bj_RESCUE_PING_TIME: number;
declare var bj_setPlayerTargetColor: Option<playercolor>;
declare var bj_slotControl: Record<number, Option<mapcontrol>>;
...
declare var bj_stockItemPurchased: Option<trigger>;
declare var bj_stockPickedItemLevel: number;
declare var bj_stockPickedItemType: Option<itemtype>;
declare var bj_stockUpdateTimer: Option<timer>;
...
declare var bj_suspendDecayBoneGroup: Option<group>;
declare var bj_suspendDecayFleshGroup: Option<group>;
...
declare var bj_victoryDialogSound: Option<sound>;
declare var bj_volumeGroupsTimer: Option<timer>;
declare const bj_WAIT_FOR_COND_MIN_INTERVAL: number;
declare var bj_wantDestroyGroup: boolean;
declare var filterEnumDestructablesInCircleBJ: Option<boolexpr>;
declare var filterGetUnitsInRectOfPlayer: Option<boolexpr>;
declare var filterGetUnitsOfPlayerAndTypeId: Option<boolexpr>;
declare var filterGetUnitsOfTypeIdAll: Option<boolexpr>;
declare var filterIssueHauntOrderAtLocBJ: Option<boolexpr>;
declare var filterLivingPlayerUnitsOfTypeId: Option<boolexpr>;
declare var filterMeleeTrainedUnitIsHeroBJ: Option<boolexpr>;
...
declare function AddWeatherEffectSaveLast(where: rect, effectID: number): Option<weathereffect>;
...
declare function ConvertedPlayer(convertedPlayerId: number): Option<player>;
...
declare function CreateCorpseLocBJ(unitid: number, whichPlayer: player, loc: location): Option<unit>;
declare function CreateDeadDestructableLocBJ(objectid: number, loc: location, facing: number, scale: number, variation: number): Option<destructable>;
declare function CreateDefeatConditionBJ(description: string): Option<defeatcondition>;
declare function CreateDestructableLoc(objectid: number, loc: location, facing: number, scale: number, variation: number): Option<destructable>;
declare function CreateFogModifierRadiusLocBJ(enabled: boolean, whichPlayer: player, whichFogState: fogstate, center: location, radius: number): Option<fogmodifier>;
declare function CreateFogModifierRadiusLocSimple(whichPlayer: player, whichFogState: fogstate, center: location, radius: number, afterUnits: boolean): Option<fogmodifier>;
...
declare function CreateImageBJ(file: string, size: number, where: location, zOffset: number, imageType: number): Option<image>;
declare function CreateItemLoc(itemId: number, loc: location): Option<item>;
declare function CreateLeaderboardBJ(toForce: force, label: string): Option<leaderboard>;
declare function CreateMultiboardBJ(cols: number, rows: number, title: string): Option<multiboard>;
declare function CreateNUnitsAtLoc(count: number, unitId: number, whichPlayer: player, loc: location, face: number): Option<group>;
declare function CreateNUnitsAtLocFacingLocBJ(count: number, unitId: number, whichPlayer: player, loc: location, lookAt: location): Option<group>;
declare function CreatePermanentCorpseLocBJ(style: number, unitid: number, whichPlayer: player, loc: location, facing: number): Option<unit>;
declare function CreateQuestBJ(questType: number, title: string, description: string, iconPath: string): Option<quest>;
declare function CreateQuestItemBJ(whichQuest: quest, description: string): Option<questitem>;
declare function CreateTextTagLocBJ(s: string, loc: location, zOffset: number, size: number, red: number, green: number, blue: number, transparency: number): Option<texttag>;
declare function CreateTextTagUnitBJ(s: string, whichUnit: unit, zOffset: number, size: number, red: number, green: number, blue: number, transparency: number): Option<texttag>;
declare function CreateTimerBJ(periodic: boolean, timeout: number): Option<timer>;
declare function CreateTimerDialogBJ(t: timer, title: string): Option<timerdialog>;
declare function CreateUbersplatBJ(where: location, name: string, red: number, green: number, blue: number, alpha: number, forcePaused: boolean, noBirthTime: boolean): Option<ubersplat>;
declare function CreateUnitAtLocSaveLast(id: player, unitid: number, loc: location, face: number): Option<unit>;
...
declare function DialogAddButtonWithHotkeyBJ(whichDialog: dialog, buttonText: string, hotkey: number): Option<button>;
...
declare function GetAbilityEffectBJ(abilcode: number, t: effecttype, index: number): Option<string>;
declare function GetAbilityName(abilcode: number): Option<string>;
declare function GetAbilitySoundBJ(abilcode: number, t: soundtype): Option<string>;
...
declare function GetItemOfTypeFromUnitBJ(whichUnit: unit, itemId: number): Option<item>;
...
declare function GetRandomSubGroup(count: number, sourceGroup: group): Option<group>;
declare function GetRandomSubGroupEnum(): void;
declare function GetRectCenter(whichRect: rect): Option<location>;
declare function GetRectFromCircleBJ(center: location, radius: number): Option<rect>;
...
declare function GetUnitsInRangeOfLocAll(radius: number, whichLocation: location): Option<group>;
declare function GetUnitsInRangeOfLocMatching(radius: number, whichLocation: location, filter: boolexpr): Option<group>;
...
declare function GetUnitsOfPlayerAndTypeId(whichPlayer: player, unitid: number): Option<group>;
...
declare function GetUnitsOfTypeIdAll(unitid: number): Option<group>;
...
declare function LeaderboardGetIndexedPlayerBJ(position: number, lb: leaderboard): Option<player>;
...
declare function LoadAbilityHandleBJ(key: number, missionKey: number, table: hashtable): Option<ability>;
declare function LoadBooleanBJ(key: number, missionKey: number, table: hashtable): boolean;
declare function LoadBooleanExprHandleBJ(key: number, missionKey: number, table: hashtable): Option<boolexpr>;
declare function LoadButtonHandleBJ(key: number, missionKey: number, table: hashtable): Option<button>;
declare function LoadDefeatConditionHandleBJ(key: number, missionKey: number, table: hashtable): Option<defeatcondition>;
declare function LoadDestructableHandleBJ(key: number, missionKey: number, table: hashtable): Option<destructable>;
declare function LoadDialogHandleBJ(key: number, missionKey: number, table: hashtable): Option<dialog>;
declare function LoadEffectHandleBJ(key: number, missionKey: number, table: hashtable): Option<effect>;
declare function LoadFogModifierHandleBJ(key: number, missionKey: number, table: hashtable): Option<fogmodifier>;
declare function LoadFogStateHandleBJ(key: number, missionKey: number, table: hashtable): Option<fogstate>;
declare function LoadForceHandleBJ(key: number, missionKey: number, table: hashtable): Option<force>;
declare function LoadGameBJ(loadFileName: string, doScoreScreen: boolean): void;
declare function LoadGroupHandleBJ(key: number, missionKey: number, table: hashtable): Option<group>;
declare function LoadHashtableHandleBJ(key: number, missionKey: number, table: hashtable): Option<hashtable>;
declare function LoadImageHandleBJ(key: number, missionKey: number, table: hashtable): Option<image>;
declare function LoadIntegerBJ(key: number, missionKey: number, table: hashtable): number;
declare function LoadItemHandleBJ(key: number, missionKey: number, table: hashtable): Option<item>;
declare function LoadItemPoolHandleBJ(key: number, missionKey: number, table: hashtable): Option<itempool>;
declare function LoadLeaderboardHandleBJ(key: number, missionKey: number, table: hashtable): Option<leaderboard>;
declare function LoadLightningHandleBJ(key: number, missionKey: number, table: hashtable): Option<lightning>;
declare function LoadLocationHandleBJ(key: number, missionKey: number, table: hashtable): Option<location>;
declare function LoadMultiboardHandleBJ(key: number, missionKey: number, table: hashtable): Option<multiboard>;
declare function LoadMultiboardItemHandleBJ(key: number, missionKey: number, table: hashtable): Option<multiboarditem>;
declare function LoadPlayerHandleBJ(key: number, missionKey: number, table: hashtable): Option<player>;
declare function LoadQuestHandleBJ(key: number, missionKey: number, table: hashtable): Option<quest>;
declare function LoadQuestItemHandleBJ(key: number, missionKey: number, table: hashtable): Option<questitem>;
declare function LoadRealBJ(key: number, missionKey: number, table: hashtable): number;
declare function LoadRectHandleBJ(key: number, missionKey: number, table: hashtable): Option<rect>;
declare function LoadRegionHandleBJ(key: number, missionKey: number, table: hashtable): Option<region>;
declare function LoadSoundHandleBJ(key: number, missionKey: number, table: hashtable): Option<sound>;
declare function LoadStringBJ(key: number, missionKey: number, table: hashtable): Option<string>;
declare function LoadTextTagHandleBJ(key: number, missionKey: number, table: hashtable): Option<texttag>;
declare function LoadTimerDialogHandleBJ(key: number, missionKey: number, table: hashtable): Option<timerdialog>;
declare function LoadTimerHandleBJ(key: number, missionKey: number, table: hashtable): Option<timer>;
declare function LoadTrackableHandleBJ(key: number, missionKey: number, table: hashtable): Option<trackable>;
declare function LoadTriggerActionHandleBJ(key: number, missionKey: number, table: hashtable): Option<triggeraction>;
declare function LoadTriggerConditionHandleBJ(key: number, missionKey: number, table: hashtable): Option<triggercondition>;
declare function LoadTriggerEventHandleBJ(key: number, missionKey: number, table: hashtable): Option<event>;
declare function LoadTriggerHandleBJ(key: number, missionKey: number, table: hashtable): Option<trigger>;
declare function LoadUbersplatHandleBJ(key: number, missionKey: number, table: hashtable): Option<ubersplat>;
declare function LoadUnitHandleBJ(key: number, missionKey: number, table: hashtable): Option<unit>;
declare function LoadUnitPoolHandleBJ(key: number, missionKey: number, table: hashtable): Option<unitpool>;
declare function LoadWidgetHandleBJ(key: number, missionKey: number, table: hashtable): Option<widget>;
...
declare function MeleeFindNearestMine(src: location, range: number): Option<unit>;
...
declare function MeleeGetProjectedLoc(src: location, targ: location, distance: number, deltaAngle: number): Option<location>;
...
declare function MeleeRandomHeroLoc(p: player, id1: number, id2: number, id3: number, id4: number, loc: location): Option<unit>;
...
declare function OffsetLocation(loc: location, dx: number, dy: number): Option<location>;
declare function OffsetRectBJ(r: rect, dx: number, dy: number): Option<rect>;
declare function OneOnOneInitPlayerSlots(): void;
declare function OrderId2StringBJ(orderId: number): Option<string>;
...
declare function PolarProjectionBJ(source: location, dist: number, angle: number): Option<location>;
...
declare function RectFromCenterSizeBJ(center: location, width: number, height: number): Option<rect>;
...
declare function ReplaceUnitBJ(whichUnit: unit, newUnitId: number, unitStateMethod: number): Option<unit>;
...
declare function RestoreUnitLocFacingAngleBJ(key: string, missionKey: string, cache: gamecache, forWhichPlayer: player, loc: location, facing: number): Option<unit>;
...
declare function StartTimerBJ(t: timer, periodic: boolean, timeout: number): Option<timer>;
...
declare function SubStringBJ(source: string, start: number, end: number): Option<string>;
...
declare function TerrainDeformationCraterBJ(duration: number, permanent: boolean, where: location, radius: number, depth: number): Option<terraindeformation>;
declare function TerrainDeformationRandomBJ(duration: number, where: location, radius: number, minDelta: number, maxDelta: number, updateInterval: number): Option<terraindeformation>;
declare function TerrainDeformationRippleBJ(duration: number, limitNeg: boolean, where: location, startRadius: number, endRadius: number, depth: number, wavePeriod: number, waveWidth: number): Option<terraindeformation>;
declare function TerrainDeformationStopBJ(deformation: terraindeformation, duration: number): void;
declare function TerrainDeformationWaveBJ(duration: number, source: location, target: location, radius: number, depth: number, trailDelay: number): Option<terraindeformation>;
...
declare function TriggerRegisterDistanceBetweenUnits(trig: trigger, whichUnit: unit, condition: boolexpr, range: number): Option<event>;
...
declare function TriggerRegisterGameStateEventTimeOfDay(trig: trigger, opcode: limitop, limitval: number): Option<event>;
...
declare function TriggerRegisterPlayerKeyEventBJ(trig: trigger, whichPlayer: player, keType: number, keKey: number): Option<event>;
...
declare function TriggerRegisterTimerEventPeriodic(trig: trigger, timeout: number): Option<event>;
declare function TriggerRegisterTimerEventSingle(trig: trigger, timeout: number): Option<event>;
declare function TriggerRegisterTimerExpireEventBJ(trig: trigger, t: timer): Option<event>;
declare function TriggerRegisterUnitInRangeSimple(trig: trigger, range: number, whichUnit: unit): Option<event>;
declare function TriggerRegisterUnitLifeEvent(trig: trigger, whichUnit: unit, opcode: limitop, limitval: number): Option<event>;
declare function TriggerRegisterUnitManaEvent(trig: trigger, whichUnit: unit, opcode: limitop, limitval: number): Option<event>;
...
declare function UnitAddItemByIdSwapped(itemId: number, whichHero: unit): Option<item>;
...
declare function UnitDropItem(inUnit: unit, inItemID: number): Option<item>;
...
declare function UnitId2StringBJ(unitId: number): Option<string>;
...
declare function UnitItemInSlotBJ(whichUnit: unit, itemSlot: number): Option<item>;
...
declare function UnitRemoveItemFromSlotSwapped(itemSlot: number, whichHero: unit): Option<item>;
...
declare function WidgetDropItem(inWidget: widget, inItemID: number): Option<item>;
